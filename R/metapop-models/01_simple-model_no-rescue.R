...
write.csv(all_reps_pops, "data-processed/metapop-models/simple-model_no-rescue_r0.8_lambda0.1_popdynam.csv",
          row.names = FALSE)
write.csv(all_reps_noise, "data-processed/metapop-models/simple-model_no-rescue_r0.8_lambda0.1_noise.csv",
          row.names = FALSE)
