...
sh_files <- c("wget_01_CMCC-CESM_historical.sh",
              ...
              "wget_17_INM-CM4_historical.sh",
              "wget_17_INM-CM4_rcp85.sh",
...
link_codes <- c(rep("http://esgf-node.cmcc.it/thredds/fileServer/", 2), # 1
                rep("http://aims3.llnl.gov/thredds/fileServer/", 4), # 2,3
