### visualizing local spectral change 
## goal: plot or animate spectral change for a few locations 
library(tidyverse)
library(broom)
library(evobiR)
library(sp)
...
anim_save(animation = animate(gganim, fps = 25, height = 800, width = 800, 
                              start_pause = 10, end_pause = 10), 
          paste("animations/one-loc-animation_L10-y-window.gif", sep = ""))
...
anim_save(animation = animate(gganim_dots, fps = 25, height = 800, width = 800, 
                              start_pause = 10, end_pause = 10), 
          paste("animations/one-loc-dots-animation_L10-y-window.gif", sep = ""))
...
for(i in 2:100){
  combined <- image_append(c(dots[i], squiggles[i]))
  full_combined <- c(full_combined, combined)
}
